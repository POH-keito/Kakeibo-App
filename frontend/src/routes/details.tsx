          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium text-gray-700 w-64">負担割合</th>
              </tr>
            </thead>
  ...
  return (
    <tr className="hover:bg-gray-50">
      ...
      <td className="px-4 py-3 text-gray-700">
        <div className="flex items-center gap-2">
          <span className="truncate max-w-md">{transaction.content}</span>
          <span
          ...
          >
            {transaction.processing_status.replace('按分_', '')}
          </span>
        </div>
      </td>
